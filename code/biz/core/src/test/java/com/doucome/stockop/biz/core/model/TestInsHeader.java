...
public class TestInsHeader {
	...
	public static void main(String[] args) throws IOException {
		...
		String userReq = "R|10.10.10.137|100|1|027|0||1880710027|WSWT||" ;
		String login = "R|10.10.10.137|101|61|027|0||1880710027|147258|WSWT|||" ;
		byte[] b = Native.toByteArray(login) ;
